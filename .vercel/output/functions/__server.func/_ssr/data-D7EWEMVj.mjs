//#region node_modules/.nitro/vite/services/ssr/assets/data-D7EWEMVj.js
...
var allProviders = [
	...
	},
	{
		id: "minimax-cn",
		name: "MiniMax (CN)",
		description: "MiniMax's China-specific API platform (api.minimaxi.com) offering access to MiniMax M2 series models with Anthropic-compatible API for text generation.",
		type: "direct",
		status: "active",
	...
	},
	{
		...
		description: "MiniMax's subscription-based coding plan offering discounted access to M2.5 and M2.7 series models optimized for software development workflows.",
		type: "direct",
		status: "active",
		url: "https://platform.minimax.io",
		auth_type: "api_key",
	...
	},
	{
		id: "qihang-ai",
		name: "QiHang AI",
		description: "QiHang AI is a Chinese LLM inference provider offering access to various AI models via an OpenAI-compatible API. Provides pay-per-token pricing for developers integrating AI capabilities.",
		type: "direct",
		status: "active",
	...
	},
	{
		id: "quantumml",
		name: "QuantumML",
		description: "QuantumML is an AI inference provider offering access to various large language models via OpenAI-compatible API. Focuses on delivering fast and cost-effective model inference for production workloads.",
		type: "direct",
		status: "active",
	...
	},
	{
		id: "bailing",
		name: "Bailing",
		description: "Bailing is an AI inference service by Ant Group / Alipay, providing access to large language models via the TBox platform. Offers OpenAI-compatible API for seamless integration.",
		type: "direct",
		status: "active",
	...
	},
	{
		id: "berget",
		name: "Berget.AI",
		description: "Berget.AI is a European AI inference provider focused on AI sovereignty and sustainability. Offers access to powerful open-source models with per-response CO2e emission tracking, optimized for agentic applications.",
		type: "direct",
		status: "active",
		url: "https://berget.ai",
		regions: ["eu"],
	...
	},
	{
		id: "chutes",
		name: "Chutes",
		description: "Chutes is a serverless AI compute platform for open-source models. Provides high-performance inference with ephemeral jobs, batch processing, and a curated registry of SOTA open-source models accessible via OpenAI-compatible API.",
		type: "direct",
		status: "active",
		url: "https://chutes.ai",
		regions: ["us", "global"],
	...
	},
	{
		id: "inference",
		name: "Inference",
		description: "Inference is a direct AI inference provider offering OpenAI-compatible API access to various LLM models. Provides pay-per-token pricing for developers building AI-powered applications.",
		type: "direct",
		status: "active",
	...
	},
	{
		id: "opencode-go",
		name: "OpenCode Go",
		description: "Low-cost subscription service for coding agents offering reliable access to open-source models like GLM-5.1, GLM-5, Kimi K2.5, and MiniMax M2.5. Built for international users with models hosted in the US, EU, and Singapore.",
		type: "direct",
		status: "active",
	...
	},
	{
		id: "opencode",
		name: "OpenCode",
		description: "Open source AI coding agent for terminal, IDE, and desktop. Access 75+ LLM providers through Models.dev integration, or use built-in free models. Supports any model from any provider including Claude, GPT, and Gemini.",
		type: "aggregator",
		status: "active",
	...
	},
	{
		id: "inception",
		name: "Inception Labs",
		description: "Fast inference platform specializing in Mercury, the fastest reasoning LLM. Offers Mercury 2 for chat and Mercury Edit 2 for code editing with FIM and next-edit capabilities.",
		type: "direct",
		status: "active",
	...
	},
	{
		id: "ovhcloud",
		name: "OVHcloud",
		description: "European sovereign cloud provider offering AI Endpoints — serverless inference API for LLMs, voice processing, document analysis, and image analysis. Supports 40+ open-weight models with zero data retention.",
		type: "cloud",
		status: "active",
	...
	},
	{
		id: "requesty",
		name: "Requesty",
		description: "Unified LLM gateway with intelligent routing, automatic failover, and real-time observability. Access 400+ models with geo-based routing, policy controls, and PII detection. EU hosting available.",
		type: "aggregator",
		status: "active",
	...
	},
	{
		id: "the-grid-ai",
		name: "The Grid AI",
		description: "AI models platform offering text generation models optimized for various use cases. Now part of Lightning AI. Provides text-max, text-prime, and text-standard models via OpenAI-compatible API.",
		type: "direct",
		status: "active",
	...
	},
	{
		id: "submodel",
		name: "SubModel",
		description: "GPU cloud platform offering high-performance inference for open-source models including DeepSeek, Qwen, and GLM. Provides pay-per-token pricing with OpenAI-compatible API.",
		type: "cloud",
		status: "active",
	...
	},
	{
		id: "synthetic",
		name: "Synthetic",
		description: "AI platform offering curated models including MiniMax, Moonshot, NVIDIA, DeepSeek, and Qwen via subscription. Includes Always-On models, LoRA adapters, and embedding models with usage-based pricing available.",
		type: "direct",
		status: "active",
	...
	},
	{
		id: "vivgrid",
		name: "Vivgrid",
		description: "AI agent infrastructure platform offering observability, debugging, evaluation, and globally distributed inference. Supports models like GPT-5, GLM-5, and DeepSeek with geo-distributed acceleration for low latency.",
		type: "direct",
		status: "active",
	...
	},
	{
		id: "vultr",
		name: "Vultr",
		description: "Serverless inference platform for GenAI applications with global, self-optimizing AI model deployment. Deploy on AMD MI355X or NVIDIA GPUs with OpenAI-compatible API, turnkey RAG, and private cluster options.",
		type: "cloud",
		status: "active",
	...
	},
	{
		id: "firmware",
		name: "Firmware",
		description: "AI model provider offering access to proprietary and open-source models including Claude, GPT, Gemini, and Grok. Provides OpenAI-compatible API for seamless integration.",
		type: "direct",
		status: "active",
	...
	},
	{
		...
		description: "Microsoft's broad suite of AI services including Speech, Language, Vision, and Decision APIs. Provides managed AI capabilities via REST APIs with enterprise security.",
		type: "cloud",
		status: "active",
	...
	},
	{
		...
		description: "GitLab's AI-powered coding assistant integrated into the GitLab DevOps platform. Provides AI chat and code completion within GitLab's CI/CD and repository workflows.",
		type: "aggregator",
		status: "active",
	...
	},
	{
		...
		description: "CloudFerro's fully managed Generative AI service with OpenAI-compatible endpoints. Provides curated language models through Sherlock AI Hub with high security and privacy standards.",
		type: "direct",
		status: "active",
	...
	},
	{
		id: "iflowcn",
		name: "iFlow",
		description: "Chinese AI model aggregation platform offering free access to models like Kimi K2, Qwen3 Coder, and DeepSeek v3. OpenAI-compatible API with a free model marketplace.",
		type: "aggregator",
		status: "sunset",
	...
	},
	{
		id: "kilo",
		name: "Kilo",
		description: "Universal AI inference gateway that intelligently routes requests across top-tier providers (Anthropic, OpenAI, Mistral, and 500+ models). OpenAI-compatible API with unified access.",
		type: "aggregator",
		status: "active",
	...
	},
	{
		...
		description: "Chinese cloud-based AI coding assistant platform offering access to coding-specialized models including Kimi K2. Provides code completion and AI-assisted development features.",
		type: "direct",
		status: "active",
		url: "https://kuae.cn",
		regions: ["cn"],
	...
	},
	{
		id: "lucidquery",
		name: "LucidQuery",
		description: "AI inference platform specializing in code generation models including LucidNova RF1 100B and Nexus Coder. Provides OpenAI-compatible API for coding tasks.",
		type: "direct",
		status: "active",
	...
	},
	{
		id: "meganova",
		name: "MegaNova",
		description: "AI model provider offering a diverse catalog of models including DeepSeek, Meta Llama, MiniMax, Mistral, and Moonshot models via OpenAI-compatible API endpoints.",
		type: "direct",
		status: "active",
	...
	},
	{
		id: "moonshotai-cn",
		name: "Moonshot AI CN",
		description: "Moonshot AI's China-region specific deployment offering Kimi K2 and related models to Chinese developers. OpenAI-compatible API with CN data residency.",
		type: "direct",
		status: "active",
		url: "https://platform.moonshot.cn",
		regions: ["cn"],
	...
	},
	{
		...
		description: "Tencent Cloud's AI coding assistant powered by Hunyuan and混元 models. Integrated with Tencent Cloud development tools for Chinese developers.",
		type: "direct",
		status: "active",
	...
	},
	{
		id: "zenmux",
		name: "ZenMux",
		description: "Multi-provider AI router that aggregates models from OpenAI, Anthropic, Google and other providers with automatic routing for cost optimization. Supports OpenAI, Anthropic Messages, and Google Vertex protocols.",
		type: "aggregator",
		status: "active",
		url: "https://zenmux.ai",
		auth_type: "api_key",
	...
	},
	{
		id: "zai",
		name: "Z.ai",
		description: "AI platform offering access to Zhipu GLM models including GLM-4.5 and GLM-4.6 series with reasoning and multimodal capabilities. Focuses on coding and agentic workflows.",
		type: "direct",
		status: "active",
		url: "https://z.ai",
		auth_type: "api_key",
	...
	},
	{
		...
		description: "Z.ai's coding-focused subscription plan offering discounted access to GLM models optimized for software development and code generation tasks.",
		type: "direct",
		status: "active",
