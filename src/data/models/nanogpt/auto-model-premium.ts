...
export const auto_model_premium: ModelEntry = {
  model: {
    ...
    description:
      "Auto-select model (Premium tier) with 1M context window for diverse text processing.",
  ...
  offers: [
    {
      ...
      provider_model_id: "auto-model-premium",
